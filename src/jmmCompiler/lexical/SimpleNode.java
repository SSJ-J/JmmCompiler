...
class SimpleNode implements Node {
  ...
  public String toString() {
	String pre = ScannerTreeConstants.jjtNodeName[id];
	//if(name.length() == 0)
	//	return pre;
    return (pre + ": " + this.jjtGetFirstToken().toString());
  }
...
/* JavaCC - OriginalChecksum=2efe22f7eb940a6145bf8efd752b8e29 (do not edit this line) */
